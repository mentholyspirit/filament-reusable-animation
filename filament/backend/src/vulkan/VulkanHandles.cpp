...
// TODO: fix to more reasonable limit.
...
//    utils::slog.e <<"binding count=" << info.bindingCount << " " << layout << utils::io::endl;
    return layout;
}
...
//    utils::slog.e <<"n samplers=" << samplerCount << " ubo=" << uboCount <<" dubo=" << duboCount << utils::io::endl;
...
//    utils::slog.e <<"created layout=" << vklayout << utils::io::endl;
//    utils::slog.e <<"  bitmask.ubo=" << printx(bitmask.ubo) << utils::io::endl;
//    utils::slog.e <<"  bitmask.dubo=" << printx(bitmask.dynamicUbo) << utils::io::endl;
}
